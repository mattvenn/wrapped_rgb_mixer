[![run all tests](https://github.com/mattvenn/wrapped_rgb_mixer/actions/workflows/install.yaml/badge.svg?branch=actions)](https://github.com/mattvenn/wrapped_rgb_mixer/actions/workflows/install.yaml)
